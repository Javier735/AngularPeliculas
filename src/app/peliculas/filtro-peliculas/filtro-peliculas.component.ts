...
peliculas=[
  ...
  {titulo:'venom', enCines:true,proximosEstrenos:false, generos:[3],poster:'https://m.media-amazon.com/images/M/MV5BNzAwNzUzNjY4MV5BMl5BanBnXkFtZTgwMTQ5MzM0NjM@._V1_UX182_CR0,0,182,268_AL_.jpg'},
...
formularioOriginal={
  ...
  ngOnInit(): void {
    ...
    .subscribe(valores=>{
      ...
      this.escribirParamentrosBusquedaEnUrl();
    })
  }
  ...
  private escribirParamentrosBusquedaEnUrl(){
    var queryStrings=[];
